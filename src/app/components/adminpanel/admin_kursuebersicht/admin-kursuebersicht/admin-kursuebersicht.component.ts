...
@Component({
  selector: 'app-admin-kursuebersicht',
  templateUrl: './admin-kursuebersicht.component.html',
  styleUrls: ['./admin-kursuebersicht.component.css']
})
export class AdminKursuebersichtComponent implements OnInit {
